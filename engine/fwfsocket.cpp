...
{
    FWF_LOG_DEBUG(debugLogging,"addrStr=%s",addrStr);
    int a0,a1,a2,a3;
...
{
    FWF_LOG_DEBUG(debugLogging,"a0=%d, a1=%d, a2=%d, a3=%d",a0,a1,a2,a3);
...
{
    FWF_LOG_DEBUG(debugLogging,"this->IsValid()=%d, x.IsValid()=%d", IsValid(), x.IsValid());
    FWF_LOG_DEBUG(debugLogging,"this->GetAsUInt32()=%u, x.GetAsUInt32()=%u", GetAsUInt32(), x.GetAsUInt32());
    FWF_LOG_DEBUG(debugLogging,"this->port=%d, x.port=%d", port, x.port);
